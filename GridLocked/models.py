...
class Fighter (models.Model):
    ...
    # [1.2,0.8,0.5,1.5] and a defense profile could be [2,0.4,0.4,1.2]. Incoming and 
    # outgoing damage would be multiplied by the corresponding value. These would have
    # max bounds and randomized, increasing the chance of a player finding the perfect
    # robot.
